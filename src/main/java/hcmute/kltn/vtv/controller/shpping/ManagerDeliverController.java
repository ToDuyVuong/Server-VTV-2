...
public class ManagerDeliverController {
    ...
    @GetMapping("/get/{deliverId}")
    public ResponseEntity<DeliverResponse> getDeliverByDeliverId(@PathVariable("deliverId") Long deliverId,
                                                                 HttpServletRequest servletRequest) {

        String username = (String) servletRequest.getAttribute("username");

        return ResponseEntity.ok(managerDeliverService.getDeliverById(username, deliverId));
    }
    ...
    @PutMapping("/update-work/{deliverId}")
    public ResponseEntity<DeliverResponse> updateDeliverWork(@RequestBody UpdateDeliverWorkRequest request,
        ...
        return ResponseEntity.ok(managerDeliverService.updateDeliverWork(deliverId, request, usernameAdded));
    }
    ...
    public ResponseEntity<ListDeliverResponse> getListDeliverByStatus(@PathVariable("status") Status status,
        ...
        return ResponseEntity.ok(managerDeliverService.getListDeliverByStatus(username, status));
    }
    ...
    public ResponseEntity<ListDeliverResponse> getListDeliverByStatusAndTypeWork(@PathVariable("status") Status status,
        ...
        return ResponseEntity.ok(managerDeliverService.getListDeliverByStatusAndTypeWork(username, status, typeWork));
    }
