...
public interface IProductVariantShopService {
    ...
    @Transactional
    List<ProductVariant> updatePriceProductVariants(Long price, List<ProductVariant> productVariants);

    @Transactional
    List<ProductVariant> updatePriceProductVariantsByPercent(int percent, List<ProductVariant> productVariants);
