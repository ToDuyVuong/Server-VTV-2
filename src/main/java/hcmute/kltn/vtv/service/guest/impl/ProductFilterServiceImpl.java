...
public class ProductFilterServiceImpl implements IProductFilterService {
    ...
    @Override
    public ProductPageResponse getFilterProductPage(int page, int size, String filter) {
    ...
    @Override
    public ProductPageResponse getFilterProductPageByPriceRange(int page, int size, String filter,
