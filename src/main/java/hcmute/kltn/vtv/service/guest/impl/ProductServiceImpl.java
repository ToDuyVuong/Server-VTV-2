...
public class ProductServiceImpl implements IProductService {
    ...
    @Override
    public ProductPageResponse getProductPageByCategoryId(Long categoryId, int page, int size) {
        if (checkExistCategoryHasChild(categoryId)) {
            ...
            if (startIndex >= products.size()) {
                return  ProductPageResponse.productPageResponse("Không còn sản phẩm nào để hiển thị!", page, size);
            }
            ...
            return ProductPageResponse.productPageResponse(productPage,
